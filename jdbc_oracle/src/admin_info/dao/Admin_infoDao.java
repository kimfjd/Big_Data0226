...
public class Admin_infoDao {
    ...
    public List<String> Adminlogin() throws InterruptedException {
        ...
        while (true) {
            ...
            System.out.print(red + "| \n" +
                    ...
                    "⡰⠋⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠹⣦⣤⡄⠀⠀⠘⡄⠀⠈⠀⠀⡠⠋⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠸⣦⣤⡄⠀⠀⠘⡄⠀⠉⠀⠀\n          |" +exit);
            System.out.println(blue + "========================================================================" + exit);
            System.out.println(purple + "   번호 입력 :  ");
            int lo=sc.nextInt();
            System.out.println(blue + "========================================================================" + exit);
            if(lo==1){
                System.out.println("  참고 : 테스트를 위한 예시 아이디 :dyddnr33@naver.com 패스워드 : admin1691");
                System.out.println(blue + "========================================================================" + exit);
    ...
    public List<Admin_infoVo> admin_infoSelect(){
        List<Admin_infoVo> list = new ArrayList<>();
        try{
            conn= Common.getConnection();
            ...
            while (rs.next()){
                ...
                list.add(new Admin_infoVo(AdmId,AdmPw));
            }
            Common.close(rs);
            Common.close(stmt);
            Common.close(conn);
    ...
    public void RoomUpdate(){
        ...
        System.out.println(blue + "|                                                                      |" + exit);
        System.out.println(blue + "|        ------------------              ------------------            |" + exit);
        System.out.println(blue + "|       |" + exit + "   [1]방 사진   " + blue + "|            |" + exit + "   [3] 전화번호  " + blue + "|           |" + exit);
        System.out.println(blue + "|        ------------------              ------------------            |" + exit);
        System.out.println(blue + "|                                                                      |" + exit);
        System.out.println(blue + "|" +exit+"[5] 종료 "+"|" + exit);
        System.out.println(blue + "|                                                                      |" + exit);
        System.out.println(blue + "|        ------------------              ------------------            |" + exit);
        System.out.println(blue + "|       |" + exit + "   [2] 거래방식(가격)    " + blue + "|             |" + exit + "    [4]비고     " + blue + "|            |" + exit);
        System.out.println(blue + "|        ------------------              ------------------            |" + exit);
        System.out.println(blue + "|                                                                      |" + exit);
        System.out.println(blue + "========================================================================" + exit);
        int up = sc.nextInt();
    ...
    public void AdminSelectPrn(List<Admin_infoVo> list){
        for(Admin_infoVo e: list){
            System.out.print(e.getADM_ID()+" ");
            System.out.print(e.getADM_PW()+" ");
            System.out.println();
        }
    }
